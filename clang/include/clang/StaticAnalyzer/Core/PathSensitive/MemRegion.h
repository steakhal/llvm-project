...
class ParamVarRegion : public VarRegion {
  ...
  /// for. This is not necessarily the index of the corresponding argument in
  /// `OriginExpr`; see `CallEvent::getDeclaredParameterIndex()`.
  unsigned Index;
...
public:
  ...
  /// \returns the declared parameter of the callee that this region stands for,
  /// i.e. `getStackFrame()->getDecl()->parameters()[getIndex()]`.
