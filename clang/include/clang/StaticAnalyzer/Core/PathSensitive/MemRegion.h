...
private:
  // We don't use llvm::Optional here intentionally.
  // That would introduce padding, which would lead to suboptimal memory layout.
  // The order of the members are intentionally sorted descending by sizeof.
