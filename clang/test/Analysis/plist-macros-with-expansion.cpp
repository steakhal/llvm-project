...
// CHECK: <key>name</key><string>TO_NULL(&amp;ptr)</string>
...
// CHECK: <key>name</key><string>TO_NULL(&amp;a)</string>
// CHECK-NEXT: <key>expansion</key><string>setToNull (&amp;a )</string>

// CHECK: <key>name</key><string>DEREF(a)</string>
...
// CHECK: <key>name</key><string>WILL_UNDEF_SET_NULL_TO_PTR(ptr)</string>
...
// CHECK: <key>name</key><string>WILL_REDIFINE_MULTIPLE_TIMES_SET_TO_NULL(ptr)</string>
// CHECK-NEXT: <key>expansion</key><string>ptr =nullptr ;</string>
...
// CHECK: <key>name</key><string>PASS_PTR_TO_MACRO_THAT_WILL_BE_UNDEFD(ptr)</string>
// CHECK-NEXT: <key>expansion</key><string>ptr =nullptr ;</string>
...
// CHECK: <key>name</key><string>TO_NULL_AND_PRINT(a, &quot;Will this , cause a crash?&quot;)</string>
...
// CHECK: <key>name</key><string>CALL_FUNCTION(setToNull(&amp;a))</string>
// CHECK-NEXT: <key>expansion</key><string>setToNull (&amp;a )</string>
...
// CHECK: <key>name</key><string>CALL_FUNCTION(setToNullAndPrint(&amp;a, &quot;Hello!&quot;))</string>
...
// CHECK: <key>name</key><string>CALL_FUNCTION_WITH_TWO_PARAMS(setToNullAndPrint, &amp;a, &quot;Hello!&quot;)</string>
// CHECK-NEXT: <key>expansion</key><string>setToNullAndPrint (&amp;a ,&quot;Hello!&quot;)</string>
...
// CHECK: <key>name</key><string>CALL_LAMBDA(([&amp;ptr, str] () mutable { TO_NULL(&amp;ptr); }))</string>
...
// CHECK: <key>name</key><string>PASTE_CODE({ // expected-warning
...
// CHECK: <key>name</key><string>POTENTIALLY_EMPTY_PARAM(,ptr)</string>
// CHECK-NEXT: <key>expansion</key><string>;ptr =nullptr </string>
...
// CHECK: <key>name</key><string>NESTED_EMPTY_PARAM(, ptr)</string>
// CHECK-NEXT: <key>expansion</key><string>;ptr =nullptr ;</string>
...
// CHECK: <key>name</key><string>CALL_FUNCTION_WITH_ONE_PARAM_THROUGH_MACRO(setToNull, &amp;ptr)</string>
// CHECK-NEXT: <key>expansion</key><string>setToNull (&amp;ptr )</string>
...
// CHECK: <key>name</key><string>VARIADIC_SET_TO_NULL(ptr, 1, 5, &quot;haha!&quot;)</string>
...
// CHECK: <key>name</key><string>VARIADIC_SET_TO_NULL(ptr)</string>
...
// CHECK: <key>name</key><string>DECLARE_FUNC_AND_SET_TO_NULL(whatever, ptr)</string>
...
// CHECK: <key>name</key><string>PRINT_STR(Hello, ptr)</string>
...
// CHECK: <key>name</key><string>EUCLIDEAN_ALGORITHM(A, B)</string>
...
// CHECK: <key>name</key><string>YET_ANOTHER_SET_TO_NULL(5, DO_NOTHING2(&quot;Remember the Vasa&quot;), ptr)</string>
...
// CHECK: <key>name</key><string>APPLY_ZERO1(FOO)</string>
...
// CHECK: <key>name</key><string>DISPATCH(x, &quot;LF1M healer&quot;)</string>
...
// CHECK: <key>name</key><string>CONCAT_VA_ARGS(x, &quot;You need to construct additional pylons.&quot;, &apos;c&apos;, 9)</string>
...
// CHECK: <key>name</key><string>CONCAT_VA_ARGS(x, &quot;You need to construct&quot;)</string>
...
// CHECK: <key>name</key><string>STRINGIFIED_VA_ARGS(x, &quot;Additional supply depots required.&quot;, &apos;a&apos;, 10)</string>
...
// CHECK: <key>name</key><string>STRINGIFIED_VA_ARGS(x, &quot;Additional supply depots required.&quot;)</string>
...
// CHECK: <key>name</key><string>BZ44493_GNUVA(a, &quot;arg2&quot;)</string>
